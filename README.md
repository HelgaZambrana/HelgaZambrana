...
- [**Olist CLV-ML**](https://github.com/HelgaZambrana/olist-clv-ml) — Customer LTV prediction model → two-layer PostgreSQL architecture (raw + star schema) → XGBoost Regressor
