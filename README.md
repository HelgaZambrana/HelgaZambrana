...
📊 **Current projects:**
* __F1 Alpine Performance Tracker__: Race analytics using FastF1 API → Python ETL → Supabase → Tableau dashboards
* __Olist CLV-ML__: Customer retention model using Brazilian e-commerce data → two-layer PostgreSQL architecture (raw + star schema) → XGBoost classifier
