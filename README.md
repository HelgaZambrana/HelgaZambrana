...
📊 **Current projects:**
- **F1 Alpine Performance Tracker** End-to-end data pipeline tracking Alpine F1 Team across 2025-2026. FastF1 + OpenF1 → Python → PostgreSQL (Supabase) → SQL analysis → Tableau Public. Automated ingestion via GitHub Actions. Includes qualifying gap analysis, tyre strategy and midfield comparison. [Dashboard](https://public.tableau.com/app/profile/helga.zambrana/viz/F1_Alpine/Race) · [Repo](https://github.com/helgazambrana/f1-2026)
- [**Olist CLV-ML**](https://github.com/HelgaZambrana/olist-clv-ml) — Customer LTV prediction model → two-layer PostgreSQL architecture (raw + star schema) → XGBoost Regressor → Tableau
